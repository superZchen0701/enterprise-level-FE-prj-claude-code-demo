...
**Commit Message 格式**（依据 `@docs/ai-context/coding-standards.md`）：
...
| 修改 | .claude/hooks/keyword-trigger.js |
| ... | ... |
...
**修改文件**：
- `.claude/hooks/keyword-trigger.js` - 添加新的关键词触发规则
...
- [编码规范 - Git 提交规范](@docs/ai-context/coding-standards.md)
